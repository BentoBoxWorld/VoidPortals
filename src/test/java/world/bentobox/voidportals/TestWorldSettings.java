...
/**
 * Minimal WorldSettings implementation for use in tests. The world flag map is a
 * persistent, mutable map so tests can enable {@code VOID_WORLD_TELEPORT_FLAG}.
 */
